...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WIFI_NM_WPA_SUPPLICANT_LOG_LEVEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WIFI_NM_WPA_SUPPLICANT_DEBUG_LEVEL, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_REVISION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MICROMINUTES_V1_1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_NRF_CALIBRATION_PERIOD, 1000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_MAX_LEVEL, 2);
