...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 864);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_RX_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_DISCARDABLE_SIZE, 43);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_DISCARDABLE_COUNT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_WORK_STACK_SIZE, 256);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_DELAY, 500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NUS_THREAD_STACK_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEQUENCE_SAMPLES, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEQUENCE_RESOLUTION, 12);
